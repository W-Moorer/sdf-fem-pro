...
\graphicspath{{../results/paper_final/figures/}{../results/phase7/}{../results/external_fem/}{../results/external_contact_solver/}{../results/c3d8_contact_trajectory_quick/figures/}{results/paper_final/figures/}{results/phase7/}{results/external_fem/}{results/external_contact_solver/}{results/c3d8_contact_trajectory_quick/figures/}{numerical_experiments/calculix_contactenergy_c3d8_replay/figures/}{paper/numerical_experiments/calculix_contactenergy_c3d8_replay/figures/}{numerical_experiments/block_drop_dynamic_sdf_calculix_1s/figures/}{paper/numerical_experiments/block_drop_dynamic_sdf_calculix_1s/figures/}{numerical_experiments/c3d8_contact_trajectory_validation/figures/}{paper/numerical_experiments/c3d8_contact_trajectory_validation/figures/}{numerical_experiments/phase9_full_contact_validation/figures/}{paper/numerical_experiments/phase9_full_contact_validation/figures/}}
...
The final paper-scale performance and material-space baseline results are taken from the Phase-6 non-quick experiment package under \path{results/paper_final}. Physical-comparison evidence is generated by the Phase-7 package and the locked paper numerical experiments under \path{paper/numerical_experiments}. The recorded Phase-6 runtime metadata is Python 3.13.5, NumPy 2.1.3, SciPy 1.15.3, Matplotlib 3.10.0, Windows 11 AMD64, and 24 logical CPUs.
